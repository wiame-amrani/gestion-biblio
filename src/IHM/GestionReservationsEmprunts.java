...
public class GestionReservationsEmprunts extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        rendreButton.setForeground(Color.DARK_GRAY);
        emprunterButton = new javax.swing.JButton();
        emprunterButton.setForeground(Color.DARK_GRAY);
        affEmpButton = new javax.swing.JButton();
        affEmpButton.setForeground(Color.DARK_GRAY);
        affExempButton = new javax.swing.JButton();
        affExempButton.setForeground(Color.DARK_GRAY);
        ...
        rendreButton.setFont(new Font("High Tower Text", Font.BOLD | Font.ITALIC, 18)); // NOI18N
        ...
        emprunterButton.setFont(new Font("High Tower Text", Font.BOLD | Font.ITALIC, 18)); // NOI18N
        ...
        affEmpButton.setFont(new Font("High Tower Text", Font.BOLD | Font.ITALIC, 18)); // NOI18N
        ...
        affExempButton.setFont(new Font("High Tower Text", Font.BOLD | Font.ITALIC, 18)); // NOI18N
        ...
        empruntsButton.setFont(new Font("High Tower Text", Font.BOLD | Font.ITALIC, 18)); // NOI18N
        ...
        ReservationButton.setFont(new Font("High Tower Text", Font.BOLD | Font.ITALIC, 18)); // NOI18N
        ...
        retourButton.setFont(new Font("High Tower Text", Font.BOLD | Font.ITALIC, 18)); // NOI18N
        ...
        titleResaEmpLabel.setFont(new Font("High Tower Text", Font.BOLD, 36)); // NOI18N
        titleResaEmpLabel.setForeground(Color.DARK_GRAY);
        titleResaEmpLabel.setText("Gestion des Réservations et Emprunts");

        jPanel3.setBackground(new java.awt.Color(255, 255, 255));

        typeOeuvreLabel1.setFont(new Font("High Tower Text", Font.BOLD | Font.ITALIC, 14)); // NOI18N
        typeOeuvreLabel1.setForeground(Color.DARK_GRAY);
        typeOeuvreLabel1.setText("Type de l'oeuvre");

        identifiantLabel1.setFont(new Font("High Tower Text", Font.BOLD | Font.ITALIC, 14)); // NOI18N
        identifiantLabel1.setForeground(Color.DARK_GRAY);
        identifiantLabel1.setText("Identifiant ");

        auteurLabel1.setFont(new Font("High Tower Text", Font.BOLD | Font.ITALIC, 14)); // NOI18N
        auteurLabel1.setForeground(Color.DARK_GRAY);
        auteurLabel1.setText("Auteur");

        titreLabel1.setFont(new Font("High Tower Text", Font.BOLD | Font.ITALIC, 14)); // NOI18N
        titreLabel1.setForeground(Color.DARK_GRAY);
        titreLabel1.setText("Titre");

        categorieLabel1.setFont(new Font("High Tower Text", Font.BOLD | Font.ITALIC, 14)); // NOI18N
        categorieLabel1.setForeground(Color.DARK_GRAY);
        categorieLabel1.setText("Catégorie");

        nbExemplaire1.setFont(new Font("High Tower Text", Font.BOLD | Font.ITALIC, 14)); // NOI18N
        nbExemplaire1.setForeground(Color.DARK_GRAY);
